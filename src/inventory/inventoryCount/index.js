...
const InventoryCount = () => {
    ...
    const CountOption = ({ name, route }) => {
        return (
            <TouchableOpacity onPress={() => navigation.navigate(route)} style={[styles.countOption, globalStyles.dFlexR]}>
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ padding: 40 }}>
                ...
                <CountOption name="Cycle Count Schedule" route="inventory_cycle_schedule" />
